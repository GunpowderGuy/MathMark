...
(define csegen-33 (cons (lambda (eta-0) (lambda (eta-1) (MathExpr-eqJSToken eta-0 eta-1))) (lambda (u--a) (lambda (u--b) (let ((sc0 (MathExpr-eqJSToken u--a u--b))) (cond ((equal? sc0 1) 0) (else 1)))))))
...
(define MathExpr-subs (lambda () (TextC-45ParseC-45Core-C-60C-42C-62 1 (TextC-45ParseC-45Core-u--map_Functor_C-40C-40C-40C-40GrammarC-32C-36bC-41C-32C-36sC-41C-32C-36tC-41C-32C-36eC-41 (lambda (eta-0) (lambda (eta-1) (vector 2 eta-0 eta-1))) MathExpr-lit) (lambda () (vector 4 (TextC-45ParseC-45Core-is csegen-33 (vector 0 #\-)) (csegen-40))))))
(define MathExpr-sub (lambda () (vector 7 (MathExpr-subs) (lambda () (MathExpr-value2)))))
(define MathExpr-add2 (lambda () (TextC-45ParseC-45Core-C-60C-42C-62 1 (TextC-45ParseC-45Core-u--map_Functor_C-40C-40C-40C-40GrammarC-32C-36bC-41C-32C-36sC-41C-32C-36tC-41C-32C-36eC-41 (lambda (eta-0) (lambda (eta-1) (vector 1 eta-0 eta-1))) MathExpr-lit) (lambda () (vector 4 (TextC-45ParseC-45Core-is csegen-33 (vector 0 #\+)) (csegen-40))))))
(define MathExpr-sum (lambda () (vector 7 (MathExpr-add2) (lambda () (MathExpr-value2)))))
(define MathExpr-value2 (lambda () (vector 7 MathExpr-lit (lambda () (vector 7 (MathExpr-sub) (lambda () (MathExpr-sum)))))))
(define csegen-40 (lambda () (lambda (_-4039) (vector 4 (vector 4 (TextC-45ParseC-45Core-is csegen-33 (vector 0 #\()) (lambda (_-4040) (MathExpr-value2))) (lambda (arg-0) (TextC-45ParseC-45Core-u--map_Functor_C-40C-40C-40C-40GrammarC-32C-36bC-41C-32C-36sC-41C-32C-36tC-41C-32C-36eC-41 (lambda (eta-0) arg-0) (TextC-45ParseC-45Core-is csegen-33 (vector 0 #\)))))))))
...
(define csegen-93 (LanguageC-45ReflectionC-45Derive-mkOrd (cons (lambda (eta-0) (lambda (eta-1) (TextC-45Bounds-eqPosition eta-0 eta-1))) (lambda (u--a) (lambda (u--b) (let ((sc0 (TextC-45Bounds-eqPosition u--a u--b))) (cond ((equal? sc0 1) 0) (else 1)))))) (lambda (eta-0) (lambda (eta-1) (TextC-45Bounds-ordPosition eta-0 eta-1)))))
...
(define Main-jsonStr "{ \"name\": \"John\", \"age\": 30, \"city\": \"New York\" }")
...
(define TextC-45Bounds-u--C-60C-43C-62_Semigroup_Bounds (lambda (arg-0 arg-1) (if (null? arg-0) arg-1 (if (null? arg-1) arg-0 (let ((e-0 (car arg-0))) (let ((e-1 (cdr arg-0))) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (cons (let ((sc4 csegen-93)) (let ((e-8 (vector-ref sc4 7))) ((e-8 e-0) e-2))) (let ((sc4 csegen-93)) (let ((e-7 (vector-ref sc4 6))) ((e-7 e-1) e-3))))))))))))
